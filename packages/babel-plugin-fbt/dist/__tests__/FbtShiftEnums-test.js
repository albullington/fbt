...
describe('Test removeEnumsFromPhrases', () => {
  extractEnumsAndFlattenPhrasesTestData.forEach(data => it(data.name, () => expect(extractEnumsAndFlattenPhrases(data.input)).toEqual(data.output)));
});
...
describe('Test shiftEnumsToTop', () => {
  shiftEnumsToTopTestData.forEach(data => it(data.name, () => expect(shiftEnumsToTop(data.input)).toEqual(data.output)));
});