...
describe('FbtConstants', () => {
  ...
  describe('ModuleNameRegExp', () => {
    it('should allow common fbt/fbs code patterns', () => {
      const scenarios = [`<fbt desc="..."`, `fbt(foo)`, `fbt.c(foo)`, `<fbs desc="..."`, `fbs(foo)`, `fbs.c(foo)`];
    ...
    it('should reject code patterns resembling fbt/fbs', () => {
      const scenarios = [`<FbTask desc="..."`, `fbsource(foo)`, `fbt.toString()`, `fbs.toString()`, `const a: Fbt = ...`, `const a: Fbs = ...`];
