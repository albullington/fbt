...
describe('translate-test.js', () => {
  describe('should translate new jsfbt payload', () => {
    ...
    function testTranslateNewPhrases(options) {
          ...
          translationGroups: [{
            ...
            translations: {
              'gVKMc/8jq5vnYR5v2bb32g==': {
                ...
                types: [3],
                translations: [{
                  translation: 'translation is: {name} has shared {=[number] photos}. View =[number] photos',
                  id: 108537963,
                  variations: {
                    '0': 2
                  }
      ...
      it('should translate string with metadata entries that create no ' + 'hidden variation. Note: this string was collected in RN mode.', () => {
        const result = processJSON({
          phrases: [{
            hashToLeaf: {
